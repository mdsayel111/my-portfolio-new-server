...
import { createHeroAnimationTextService, getHeroAnimationTextService, updateHeroAnimationTextService } from "./service";
import catchAsync from "../../../../HOF/catch-async";
import { sendResponse } from "../../../utils/send-response";

// create getSingleHeroAnimationText controller
export const getHeroAnimationText: RequestHandler = catchAsync(async (_, res) => {
...
export const createHeroAnimationText: RequestHandler = catchAsync(async (req, res) => {
...
export const updateHeroAnimationText: RequestHandler = catchAsync(async (req, res) => {
  const { id } = req.params;
  const heroAnimationTextData = req.body;

  const data = await updateHeroAnimationTextService(id, heroAnimationTextData);
